...
import translationEN from './locales/en.json'; // Загружаем файл с переводом для английского
import translationFR from './locales/fr.json'; // Загружаем файл с переводом для французского
